...
all: $(LOOPER_TARGET) $(PATCH_MENU_TARGET) $(STEREO_PAN_TARGET) $(DISKRECORD_TARGET)
...
clean:
	rm -f $(LOOPER_TARGET) $(PATCH_MENU_TARGET) $(STEREO_PAN_TARGET) $(DISKRECORD_TARGET) $(TEST_PM) $(TEST_PAN)
